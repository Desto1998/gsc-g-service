...
<div class="" style="font-size: 15px">
    ...
    <table>
        ...
        <tr>
            <td>TOTALEMENT OPERATIONNEL</td>&nbsp;&nbsp;&nbsp;
            <td style="margin-left: 20px">OUI <label for=""><input type="text"></label></td>
            <td style="margin-left: 20px">NON <label for=""><input type="text"></label></td>
        </tr>
        <tr>
            <td>INTERVENTION A CONTINUER</td>&nbsp;&nbsp;&nbsp;
            <td style="margin-left: 20px">OUI <label for=""><input type="text"></label></td>
            <td style="margin-left: 20px">NON <label for=""><input type="text"></label></td>
        </tr>
    </table>
<table style="width: 100%;margin-top: 10px">
    <tr>
        ...
        <td style="float: right;text-align: right">SIGNATURE DU GSC</td>
    </tr>
</table>
