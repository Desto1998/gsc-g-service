    ...
    $('#addFields').on('click', function (event) {
        ...
        if (num == '' || modele == '' || marque == '') {
            ...
            // if (typeOperation===1){
                ...
                table += '<td style="border:1px solid #eaeaea;"><input type="text" required name="num[]" class="form-control" value="' + num + '"></td>'
                table += '<td style="border:1px solid #eaeaea;"><input type="text" required name="marque[]" class="form-control marque" value="' + marque + '"  id="marque' + totalInputs + '"></td>'
                table += '<td style="border:1px solid #eaeaea;"><input type="text" required name="model[]" class="form-control model" value="' + modele + '"  id="model' + totalInputs + '"></td>'
                table += '<td style="border:1px solid #eaeaea;"><textarea name="description[]" class="form-control">' + desc + '</textarea></td>'
                table += '<td style="border:1px solid #eaeaea;"><input type="number" name="prix[]" step="any" required class="form-control prix" value="' + prix + '"  id="prix' + totalInputs + '"></td>'
                table += '<input type="hidden" name="acce[]" class="form-control" value="' + acce + '"  id="acce' + totalInputs + '">'
                table += '<input type="hidden" name="etat[]" class="form-control" value="' + etat + '"  id="etat' + totalInputs + '">'
            ...
            //     table += '<td style="border:1px solid #eaeaea;"><input type="number" name="prix_com[]" step="any" required class="form-control prix_com" value="' + prix + '" onchange="calculeComHT(' + totalInputs + ')" id="prix_com' + totalInputs + '"></td>'
